...
export default function Projects() {
    return (
        <>
            ...
            <div id="Projects" className="w-full pt-0 lg:max-w-full px-4 sm:px-2 sm:py-4 lg:px-0">
                <motion.div
                    initial="hidden"
                    whileInView="show"
                    viewport={{ once: false, amount: 0.25 }}
                    className="relative z-0 top-4 px-4 py-12 sm:py-5 md:py-20 lg:px-12"
                >
                    <motion.h1
                    ...
                    <div className="flex flex-wrap">
                        ...
                        >
                            ...
                            <div className="text-white">
                                ...
                                <p>
                                    <Link href="../sro-sha-1/" className="">Click here for more details...</Link>
                                </p>
                            </div>
                        </motion.div>
                        <motion.div
                        ...
                        >
                            ...
                            <div className="text-white">
                                ...
                                <Link href="../danishkol-mine/" className="">Click here for more details...</Link>
                            </div>
                        </motion.div>
                        <motion.div
                        ...
                        >
                            ...
                            <div className="text-white">
                                ...
                                <Link href="../kamangara-mine/" className="">Click here for more details...</Link>
                            </div>
                        </motion.div>
                    </div>
                    <Image
